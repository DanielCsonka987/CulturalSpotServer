...
module.exports.profiles = [
    {
        ...
        lastLoggedAt: new Date('08 August 2021 23:21 UTC'),
        resetPwdMarker: '',
        refreshToken: '',

        myPosts: [
            { postid: postids[0], createdAt: new Date('14 April 2021 07:11 UTC') }, 
            { postid: postids[5], createdAt: new Date('04 April 2021 23:59 UTC') } 
        ],
        myChats: [chatids[0]],
    ...
    {
        _id: userids[1],
        email: 'mymail@nomailihope.com',
        username: 'Fraser',
        pwdHash: '$2b$12$MRSBPUJkPgav1B4pFGJsE.hrn0vZZ19/kjpIaOUpGFUlr7X2zF3Uu',     // testing
        registeredAt: new Date('18 June 2019 16:04 UTC'),
        lastLoggedAt: new Date('28 July 2021 12:32 UTC'),
        resetPwdMarker: '',
        refreshToken: '',

        myPosts: [
            { postid: postids[3], createdAt: new Date('10 June 2021 16:54 UTC') }, 
            { postid: postids[4], createdAt: new Date('12 June 2021 10:26 UTC') },
        ],
    ...
    {
        _id: userids[2],
        email: 'email@nomailihope.jp',
        username: 'Caster',
        pwdHash: '$2b$12$XBj3d7FG3ETwbHtIaEd2vuWdq.8wpLtmxHN8JdLEae5s5attfPFVC',     // testing
        registeredAt: new Date('13 May 2021 13:10 UTC'),
        lastLoggedAt: new Date('21 July 2021 06:10 UTC'),
        resetPwdMarker: '',
        refreshToken: '',

        myPosts: [
            { postid: postids[2], createdAt: new Date('16 May 2021 16:26 UTC')}
        ],
    ...
    {
        _id: userids[3],
        email: 'myacc@nomailihope.com',
        username: 'Passer By',
        pwdHash: '$2b$12$mZqGaZe0EY3RWCV8.U5CD.n5bOdapHztkHoVzkunATOtsovbjxobC',     // testing
        registeredAt: new Date('13 May 2020 13:37 UTC'),
        lastLoggedAt: new Date('03 February 2021 13:37 UTC'),
        resetPwdMarker: '',
        refreshToken: '',

        myPosts: [ 
            { postid: postids[1], createdAt: new Date('22 November 2020 01:12 UTC') }, 
            { postid: postids[6], createdAt: new Date('14 August 2021 20:10 UTC') }
        ],
        myChats: [chatids[0]],
        friends: [userids[0]],
        myInvitations: [],
    ...
    {
        _id: userids[4],
        email: 'testing@nomailihope.com',
        username: 'Passenger',
        pwdHash: '$2b$12$FBM2jfgz3QgDBDewmAHvKONp9Zg.Y1NFgH.jDoEyif1aHtUzPN8RW',     // testing
        registeredAt: new Date('13 May 2018 18:30 UTC'),
        lastLoggedAt: new Date('10 August 2021 11:24 UTC'),
        resetPwdMarker: '',
        refreshToken: '',
    ...
    {
        _id: userids[5],
        email: 'testpurpose@nomailihope.com',
        username: 'Somebody',
        pwdHash: '$2b$12$puvV62aqpUXGG3JJfUHKVOC4RVSMHJkfeW7hyrQrpmHcKBU9j9NIS',     // testing
        registeredAt: new Date('11 January 2016 13:37 UTC'),
        lastLoggedAt: new Date('21 May 2021 18:21 UTC'),
        resetPwdMarker: '',
        refreshToken: '',

        myPosts: [ 
            { postid: postids[7], createdAt: new Date('16 March 2021 16:26 UTC') }
        ],
        myChats: [],
        friends: [userids[9]],
    ...
    },
    {
        ...
        registeredAt: new Date('30 May 2019 19:00 UTC'),
        lastLoggedAt: new Date('13 July 2021 13:04 UTC'),
        resetPwdMarker: '',
        refreshToken: '',
    ...
    {
        _id: userids[7],
        email: 'usermail@nomailihope.com',
        username: 'Profile_1089',
        pwdHash: '$2b$12$26bRmafEWLEggXu7XA7SCuRfR3GJT.eXbSOP05mkqfxgQvATWmffO',     // testing
        registeredAt: new Date('26 September 2016 09:37 UTC'),
        lastLoggedAt: new Date('13 May 2021 13:37 UTC'),
        resetPwdMarker: '',
        refreshToken: '',

        myPosts: [ 
            { postid: postids[9], createdAt: new Date('19 February 2021 14:16 UTC') }
        ],
        myChats: [chatids[1]],
        friends: [userids[1]],
        myInvitations: [],
    ...
    {
        _id: userids[8],
        email: 'mail1569@nomailihope.com',
        username: 'User Programmer',
        pwdHash: '$2b$12$.WEmolgcMWZl78bTn8sBC.w1mbR4kpE/F0hI9Bql7ylAtWi2ni3Uy',     // testing
        registeredAt: new Date('01 December 2020 15:37 UTC'),
        lastLoggedAt: new Date('24 June 2021 13:25 UTC'),
        resetPwdMarker: '',
        refreshToken: '',
    ...
    {
        _id: userids[9],
        email: 'user319mail@nomailihope.com',
        username: 'CoolGuy',
        pwdHash: '$2b$12$xDMFtCneEzaUpu0plRIk1u29i5NdriaOMnndJt980lrkHb7MoqfGS',     // testing
        registeredAt: new Date('26 May 2020 10:12 UTC'),
        lastLoggedAt: new Date('29 August 2021 15:31 UTC'),
        resetPwdMarker: '',
        refreshToken: '',

        myPosts: [ 
            { postid: postids[8], createdAt: new Date('23 May 2021 12:26 UTC') }
        ],
        myChats: [],
        friends: [userids[5]],
        myInvitations: [],
...
module.exports.posts = [
    {
        ...
        createdAt: new Date('14 April 2021 07:11 UTC'),
        updatedAt: new Date('15 April 2021 11:12 UTC'),
        comments: [],
        sentiments: [
            { 
                id: 1,
    ...
    },
    {
        ...
        createdAt: new Date('22 November 2020 01:12 UTC'),
        updatedAt: new Date('24 November 2020 10:12 UTC'),
        comments: [
            { commentid: commentids[0], createdAt: new Date('24 November 2020 10:12 UTC') }
        ],
        sentiments: []
    },
    {
        ...
        createdAt: new Date('16 May 2021 16:26 UTC'),
        updatedAt: new Date('10 May 2021 13:17 UTC'),
        comments: [
            { commentid: commentids[1], createdAt: new Date('10 May 2021 12:12 UTC') },
            { commentid: commentids[2], createdAt: new Date('10 May 2021 13:17 UTC') }
        ],
        sentiments: [
            { 
                id: 1,
    ...
    },
    {
        ...
        createdAt: new Date('10 June 2021 16:54 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        createdAt: new Date('12 June 2021 10:26 UTC'),
        updatedAt: new Date('12 June 2021 16:26 UTC'),
        comments: [
            { commentid: commentids[3], createdAt: new Date('12 June 2021 15:26 UTC') }
        ],
        sentiments: [
            { 
                id: 1,
    ...
    },
    {
        ...
        createdAt: new Date('04 April 2021 23:59 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        createdAt: new Date('14 August 2021 20:10 UTC'),
        updatedAt: new Date('14 August 2021 23:56 UTC'),
        comments: [
            { commentid: commentids[4], createdAt: new Date('14 August 2021 22:54 UTC') }, 
            { commentid: commentids[5], createdAt: new Date('14 August 2021 23:56 UTC') }
        ],
        sentiments: []
    },
    {
        ...
        createdAt: new Date('16 March 2021 16:26 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        createdAt: new Date('23 May 2021 12:26 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        createdAt: new Date('19 February 2021 14:16 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    }
...
module.exports.comments = [
    {
        ...
        rootPost: postids[1],
        createdAt: new Date('24 November 2020 10:12 UTC'),
        updatedAt: new Date('25 November 2021 22:32 UTC'),
        comments: [],
        sentiments: [
            {
                id: 1,
    ...
    },
    {
        ...
        rootPost: postids[2],
        createdAt: new Date('10 May 2021 12:12 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        parentNode: postids[2],
        rootPost: postids[2],
        createdAt: new Date('10 May 2021 13:17 UTC'),
        updatedAt: new Date('11 May 2021 23:56 UTC'),
        comments: [
            { commentid: commentids[6], createdAt: new Date('11 May 2021 23:56 UTC') }
        ],
        sentiments: []
    },
    {
        ...
        rootPost: postids[4],
        createdAt: new Date('12 June 2021 15:26 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        rootPost: postids[6],
        createdAt: new Date('14 August 2021 22:54 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        createdAt: new Date('14 August 2021 23:56 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        parentNode: postids[6],
        rootPost: postids[2],
        createdAt: new Date('11 May 2021 23:56 UTC'),
        updatedAt: '',
        comments: [ 
            { commentid: commentids[7], createdAt: new Date('12 May 2021 07:23 UTC') }, 
            { commentid: commentids[8], createdAt: new Date('12 May 2021 07:45 UTC') }
        ],
        sentiments: []
    },
    {
        ...
        parentNode: postids[6],
        rootPost: postids[2],
        createdAt: new Date('12 May 2021 07:23 UTC'),
        updatedAt: '',
        comments: [
            { commentid: commentids[9], createdAt: new Date('12 May 2021 07:46 UTC') }
        ],
        sentiments: []
    },
    {
        ...
        parentNode: postids[6],
        rootPost: postids[2],
        createdAt: new Date('12 May 2021 07:45 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    },
    {
        ...
        rootPost: postids[2],
        createdAt: new Date('12 May 2021 07:46 UTC'),
        updatedAt: '',
        comments: [],
        sentiments: []
    }
